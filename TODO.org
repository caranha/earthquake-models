...
- [ ] Add "Iterable" to CSEPModel Interface
- [ ] Decouple the Random Search from the CSEPModel Implementation
  - CSEPModel Factory with Parameter passing

- [ ] Create an interface for the optimization
- [ ] Simple GA Search
