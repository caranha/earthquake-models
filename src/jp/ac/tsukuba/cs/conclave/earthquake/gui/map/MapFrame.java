 ...
 *
 */
public class MapFrame extends JInternalFrame implements ActionListener, Observer{
	...
	public MapFrame(EarthquakeDisplayModel model)
	{
		super("Map", false, false, false, true);
		model.addObserver(this);
		
		// FIXME: should observe the model, not the map Controller
		// Model should then observe map controler.
		// What a mess!
		model.getMapController().addObserver(this);
